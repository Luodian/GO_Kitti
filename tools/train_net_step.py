...
def main():
    ...
    if args.dataset == "mapillary_train":
        cfg.TRAIN.DATASETS = ('mapillary_train',)
        cfg.MODEL.NUM_CLASSES = 38
    elif args.dataset == "mapillary_train_val":
        cfg.TRAIN.DATASETS = ('mapillary_train_val',)
        cfg.MODEL.NUM_CLASSES = 38
    elif args.dataset == "mapillary_train_val_aug":
        cfg.TRAIN.DATASETS = ('mapillary_train_val_aug',)
        cfg.MODEL.NUM_CLASSES = 38
        ...
        cfg.TRAIN.DATASETS = ('cityscape_train',)
        cfg.MODEL.NUM_CLASSES = 9
    else:
